...
public class DataSewa extends javax.swing.JDialog {
    ...
    private void pilihData() {
        ...
        if (row != -1) { // Validasi jika ada baris yang dipilih
            try {
                // Validasi jumlah kolom pada tabel
                if (tbl_data.getColumnCount() < 9) {
                    throw new ArrayIndexOutOfBoundsException("Jumlah kolom pada tabel kurang dari yang diharapkan (minimal 9 kolom).");
                }
